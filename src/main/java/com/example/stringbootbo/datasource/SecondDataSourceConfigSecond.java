...
@Configuration
@MapperScan(basePackages ="com.example.stringbootbo.mapper.secondMapper", sqlSessionTemplateRef = "secondSqlSessionTemplate")
public class SecondDataSourceConfigSecond {
